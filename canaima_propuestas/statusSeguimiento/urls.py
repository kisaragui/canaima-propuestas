...
from statusSeguimiento.views import HistorialList, Historiallistar, Principal, PreguntasEvaluacion
...
urlpatterns = [
	...
	url(r'^postulacion/listar$', PreguntasEvaluacion.as_view(), name= "evaluacion"),
]